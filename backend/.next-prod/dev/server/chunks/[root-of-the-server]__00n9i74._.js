...
"[project]/src/middleware/rate-limit.ts [middleware] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const store = new Map();
function consumeRateLimit(key, limit = 100, windowMs = 60_000) {
    const now = Date.now();
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$middleware$2f$rate$2d$limit$2e$ts__$5b$middleware$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/middleware/rate-limit.ts [middleware] (ecmascript)");
;
;
function proxy(req) {
    if (req.nextUrl.pathname.startsWith("/api/")) {
        ...
        const rate = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$middleware$2f$rate$2d$limit$2e$ts__$5b$middleware$5d$__$28$ecmascript$29$__["consumeRateLimit"])(key);
        if (!rate.allowed) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__00n9i74._.js.map