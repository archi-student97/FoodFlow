...
"[project]/src/services/restaurant.service.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const restaurantService = {
    async list (params) {
        const query = {};
        if (params.q) query.name = {
            $regex: params.q,
            $options: "i"
        };
        if (params.cuisine) query.cuisine = params.cuisine;
        const page = Math.max(Number(params.page || 1), 1);
        const limit = Math.max(Number(params.limit || __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$constants$2f$common$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["DEFAULT_PAGE_SIZE"]), 1);
        const [items, total] = await Promise.all([
            __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$repositories$2f$restaurant$2e$repository$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["restaurantRepository"].list(query, (page - 1) * limit, limit),
            __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$repositories$2f$restaurant$2e$repository$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["restaurantRepository"].count(query)
        ]);
        return {
            items,
            meta: {
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$repositories$2f$restaurant$2e$repository$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/repositories/restaurant.repository.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$restaurant$2e$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/services/restaurant.service.ts [app-route] (ecmascript)");
...
async function GET(req) {
    try {
        ...
        const data = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$restaurant$2e$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["restaurantService"].list({
            q: searchParams.get("q"),
            cuisine: searchParams.get("cuisine"),
            page: searchParams.get("page"),
            limit: searchParams.get("limit")
        });
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$api$2d$response$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["ok"])("Restaurants fetched", data);
    } catch (error) {
...
async function POST(req) {
    try {
        ...
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["connectDB"])();
        const body = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$validations$2f$restaurant$2e$validation$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["restaurantSchema"].parse(await req.json());
        const created = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$repositories$2f$restaurant$2e$repository$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["restaurantRepository"].create({
            ...body,
            ownerId: auth.user.userId
        });
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$api$2d$response$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["ok"])("Restaurant created", created, 201);
    } catch (error) {
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$error$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["handleApiError"])(error);
    }
}
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0s-tb9d._.js.map